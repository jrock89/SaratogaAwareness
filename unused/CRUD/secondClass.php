...
<div class="container">
  <!-- 1:00 table -->
  <div class="row">
    <h3>Awareness Through Movement Class 1:00pm</h3>
  </div>
  <div class="row">
    <p>
      <a href="createTwo.php" class="btn btn-success">Create</a>
    </p>
    <table class="table table-striped table-bordered">
      ...
      <tbody>
        ...
        include("database.php");
         ...
         $sql = 'SELECT * FROM ClassListTwo ORDER BY id DESC';
         foreach ($pdo->query($sql) as $row) {
                  ...
                  echo ' ';
                  echo '<a class="btn btn-success" href="updateTwo.php?id='.$row['id'].'">Update</a>';
                  echo ' ';
                  echo '<a class="btn btn-danger" href="deleteTwo.php?id='.$row['id'].'">Delete</a>';
                  echo '</td>';
          }
          Database::disconnect();
